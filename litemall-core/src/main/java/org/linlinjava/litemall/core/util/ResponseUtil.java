...
public class ResponseUtil {
    ...
    public static Object okUser(Object data) {
        LitemallUser litemallUser = (LitemallUser) data;
        LitemallUser dataLi = new LitemallUser();
        dataLi.setMobile(litemallUser.getMobile());
